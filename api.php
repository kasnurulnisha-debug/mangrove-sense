...
* Place this file in your XAMPP htdocs/mangrove/ folder.
* Handles all AJAX calls from index.html.
*
* Endpoints
...
// ── Database connection ──────────────────────────────────────
// Change $db_pass if you have set a MySQL root password in XAMPP.
$db_host = 'localhost';
$db_name = 'mangrove_sense';
$db_user = 'root';
...
switch ($action) {
    ...
    // ── GET TREES (recent list for the right-panel log) ──────
    case 'get_trees':
        ...
        $stmt   = $pdo->query(
            "SELECT tree_code, species_id, dbh_cm, tree_height_m, trunk_circumference_cm,
                    health_status, lat, lng, zone_label, updated_at
             FROM trees $where
